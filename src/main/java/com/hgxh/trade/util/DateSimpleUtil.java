 ...
 * @version 1.0
 */
public class DateSimpleUtil extends DateUtils {
	...
	public static SimpleDateFormat sdfDateTime = new SimpleDateFormat(DateSimpleUtil.DATE_FORMAT_DATETIME);
	// Global SimpleDateFormat object
	public static SimpleDateFormat sdfDateOnly = new SimpleDateFormat(DateSimpleUtil.DATE_FORMAT_DATEONLY);
	...
	public static Timestamp toSqlTimestamp(String sDate) {
		...
		if (sDate.length() != DateSimpleUtil.DATE_FORMAT_DATEONLY.length()) {
			return null;
		}
		return toSqlTimestamp(sDate, DateSimpleUtil.DATE_FORMAT_DATEONLY);
	}
	/**
	...
	public static Timestamp toSqlTimestamp(String sDate, String sFmt) {
		...
		if (sFmt.equals(DateSimpleUtil.DATE_FORMAT_DATETIME)) {
			temp = sDate.replace('/', '-');
			temp = temp + ".000000000";
		} else if (sFmt.equals(DateSimpleUtil.DATE_FORMAT_DATEONLY)) {
			temp = sDate.replace('/', '-');
	...
	public static String toSqlTimestampString2(Timestamp dt) {
		...
		String temp = toSqlTimestampString(dt, DateSimpleUtil.DATE_FORMAT_DATETIME);
	...
	public static String toSqlTimestampString(Timestamp dt, String sFmt) {
		...
		temp = dt.toString();
		if (sFmt.equals(DateSimpleUtil.DATE_FORMAT_DATETIME) || // "YYYY/MM/DD
				// HH24:MI:SS"
				sFmt.equals(DateSimpleUtil.DATE_FORMAT_DATEONLY)) { // YYYY/MM/DD
	...
	public static String timestampToStringYMD(Timestamp  timestamp){
		SimpleDateFormat sdf = new SimpleDateFormat(DateSimpleUtil.DATE_FORMAT_DATEONLY);
	...
	public static boolean isOverIntervalLimit(String startDateStr,String endDateStr,int interval){
		...
		Date endDate = null;
		try {
			startDate = DateUtils.parseDate(startDateStr, new String[]{DateSimpleUtil.DATE_FORMAT_DATEONLY});
			endDate = DateUtils.parseDate(endDateStr, new String[]{DateSimpleUtil.DATE_FORMAT_DATEONLY});
     ...
     * @param date 基准日期   days 要加的天数   format要返回的字符串类型
     * @return
     */
     ...
     * @return  当前时间
     */
    public static String getDateByFormat(String format)throws Exception {
    	Date date = new Date();
